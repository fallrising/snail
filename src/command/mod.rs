...
pub static COMMAND_TABLE: &[CommandSpec] = &[
    ...
    CommandSpec { name: "SETRANGE", min_arity: 4, max_arity: 4, route: RouteClass::Key, write: true },
    CommandSpec { name: "STRLEN", min_arity: 2, max_arity: 2, route: RouteClass::Key, write: false },
    CommandSpec { name: "DECR", min_arity: 2, max_arity: 2, route: RouteClass::Key, write: true },
    CommandSpec { name: "DECRBY", min_arity: 3, max_arity: 3, route: RouteClass::Key, write: true },
    CommandSpec { name: "INCRBY", min_arity: 3, max_arity: 3, route: RouteClass::Key, write: true },
    CommandSpec { name: "INCRBYFLOAT", min_arity: 3, max_arity: 3, route: RouteClass::Key, write: true },
    CommandSpec { name: "GETSET", min_arity: 3, max_arity: 3, route: RouteClass::Key, write: true },
    CommandSpec { name: "GETDEL", min_arity: 2, max_arity: 2, route: RouteClass::Key, write: true },
    CommandSpec { name: "GETEX", min_arity: 2, max_arity: -1, route: RouteClass::Key, write: true },
    CommandSpec { name: "SETNX", min_arity: 3, max_arity: 3, route: RouteClass::Key, write: true },
    CommandSpec { name: "SETEX", min_arity: 4, max_arity: 4, route: RouteClass::Key, write: true },
    CommandSpec { name: "PSETEX", min_arity: 4, max_arity: 4, route: RouteClass::Key, write: true },
    CommandSpec { name: "LPUSHX", min_arity: 3, max_arity: -1, route: RouteClass::Key, write: true },
    CommandSpec { name: "RPUSHX", min_arity: 3, max_arity: -1, route: RouteClass::Key, write: true },
    CommandSpec { name: "LPOP", min_arity: 2, max_arity: 3, route: RouteClass::Key, write: true },
    CommandSpec { name: "RPOP", min_arity: 2, max_arity: 3, route: RouteClass::Key, write: true },
    CommandSpec { name: "LLEN", min_arity: 2, max_arity: 2, route: RouteClass::Key, write: false },
    CommandSpec { name: "LINDEX", min_arity: 3, max_arity: 3, route: RouteClass::Key, write: false },
    CommandSpec { name: "LSET", min_arity: 4, max_arity: 4, route: RouteClass::Key, write: true },
    CommandSpec { name: "LREM", min_arity: 4, max_arity: 4, route: RouteClass::Key, write: true },
    CommandSpec { name: "LTRIM", min_arity: 4, max_arity: 4, route: RouteClass::Key, write: true },
    CommandSpec { name: "HSETNX", min_arity: 4, max_arity: 4, route: RouteClass::Key, write: true },
    CommandSpec { name: "HMGET", min_arity: 3, max_arity: -1, route: RouteClass::Key, write: false },
    CommandSpec { name: "HDEL", min_arity: 3, max_arity: -1, route: RouteClass::Key, write: true },
    CommandSpec { name: "HEXISTS", min_arity: 3, max_arity: 3, route: RouteClass::Key, write: false },
    CommandSpec { name: "HSTRLEN", min_arity: 3, max_arity: 3, route: RouteClass::Key, write: false },
    CommandSpec { name: "HKEYS", min_arity: 2, max_arity: 2, route: RouteClass::Key, write: false },
    CommandSpec { name: "HVALS", min_arity: 2, max_arity: 2, route: RouteClass::Key, write: false },
    CommandSpec { name: "HINCRBY", min_arity: 4, max_arity: 4, route: RouteClass::Key, write: true },
    CommandSpec { name: "HINCRBYFLOAT", min_arity: 4, max_arity: 4, route: RouteClass::Key, write: true },
    CommandSpec { name: "SREM", min_arity: 3, max_arity: -1, route: RouteClass::Key, write: true },
    CommandSpec { name: "SCARD", min_arity: 2, max_arity: 2, route: RouteClass::Key, write: false },
    CommandSpec { name: "SISMEMBER", min_arity: 3, max_arity: 3, route: RouteClass::Key, write: false },
    CommandSpec { name: "SMISMEMBER", min_arity: 3, max_arity: -1, route: RouteClass::Key, write: false },
    CommandSpec { name: "SPOP", min_arity: 2, max_arity: 3, route: RouteClass::Key, write: true },
    CommandSpec { name: "SRANDMEMBER", min_arity: 2, max_arity: 3, route: RouteClass::Key, write: false },
    CommandSpec { name: "ZREM", min_arity: 3, max_arity: -1, route: RouteClass::Key, write: true },
    CommandSpec { name: "ZMSCORE", min_arity: 3, max_arity: -1, route: RouteClass::Key, write: false },
    CommandSpec { name: "ZINCRBY", min_arity: 4, max_arity: 4, route: RouteClass::Key, write: true },
    CommandSpec { name: "ZREVRANGE", min_arity: 4, max_arity: 5, route: RouteClass::Key, write: false },
    CommandSpec { name: "ZPOPMIN", min_arity: 2, max_arity: 3, route: RouteClass::Key, write: true },
    CommandSpec { name: "ZPOPMAX", min_arity: 2, max_arity: 3, route: RouteClass::Key, write: true },
    CommandSpec { name: "PEXPIRE", min_arity: 3, max_arity: 3, route: RouteClass::Key, write: true },
    CommandSpec { name: "EXPIREAT", min_arity: 3, max_arity: 3, route: RouteClass::Key, write: true },
    CommandSpec { name: "PEXPIREAT", min_arity: 3, max_arity: 3, route: RouteClass::Key, write: true },
    CommandSpec { name: "PTTL", min_arity: 2, max_arity: 2, route: RouteClass::Key, write: false },
    CommandSpec { name: "PERSIST", min_arity: 2, max_arity: 2, route: RouteClass::Key, write: true },
    CommandSpec { name: "RANDOMKEY", min_arity: 1, max_arity: 1, route: RouteClass::Broadcast, write: false },
];
